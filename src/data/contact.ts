...
export const CONTACT_VISIT_PAGE = {
  ...
  heroDescription:
    "We invite you to experience our campus, meet our community, and discover what makes St. Elizabeth High School special.",
  sectionHeading: "Directions",
  introText:
    "St. Elizabeth High School is located in the village of Pomburpa in Bardez taluka, North Goa. We're easily accessible from Panjim (approximately 15 km), Mapusa (approximately 10 km), and Calangute (approximately 12 km).",
