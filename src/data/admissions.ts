...
export const WHY_ST_ELIZABETH_POINTS = [
  {
    ...
    description:
      "Our CBSE curriculum challenges students to think critically, solve problems creatively, and achieve their personal best. With an average class size of 15 students, every learner receives individual attention.",
  },
  {
...
export const FAQS = [
  {
    ...
    answer:
      "St. Elizabeth's High School follows the Central Board of Secondary Education (CBSE) curriculum, one of India's most respected national education boards.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "The academic year typically begins in June, following the standard CBSE calendar. Admissions for the upcoming year open in January.",
  },
] as const;
