...
export const STRATEGIC_PLAN_POINTS = [
  {
    ...
    description: "Integrating 21st-century skills and technology across the CBSE curriculum while maintaining our commitment to foundational knowledge.",
  },
  {
    title: "Campus Development",
    description: "Enhancing facilities including new science labs, a performing arts centre, and upgraded sports infrastructure.",
  },
  {
    title: "Community Engagement",
    description: "Strengthening partnerships with families, alumni, and the broader Bardez community to enrich the student experience.",
  },
  {
    title: "Sustainability",
    description: "Promoting environmental stewardship through green campus initiatives, waste reduction programs, and eco-education.",
  },
] as const;
